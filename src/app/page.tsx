...
export default function Home() {
  return (
    <div>
      <div className="min-h-screen min-w-screen bg-[rgb(32, 33, 37)] bg-grid-white/[0.07] relative flex flex-col items-center">
        <Header />
        ...
        <div className="w-4/5 flex flex-col items-end justify-end text-right">
          ...
          <button className="bg-white py-3 px-4 rounded-lg z-10 text-black tracking-tighter hover:scale-110 transition-all duration-100"><span className={inter.className}>Try for free</span></button>
        </div>
      </div>
      <Pagetwo />
      <Pagethree />
